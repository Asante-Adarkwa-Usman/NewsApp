package com.ghost.newsapp.core.data
...
import com.ghost.newsapp.core.utils.API_KEY
import com.ghost.newsapp.core.utils.BASE_URL
...
class NewsRepositoryImpl(
    ...
    private suspend fun getRemoteNews(nextPage: String?): NewsList {
        val newsListDto: NewsListDto = httpClient.get(BASE_URL) {
            parameter("apikey", API_KEY) //create constants.kt file to keep baseUrl and Apikey
